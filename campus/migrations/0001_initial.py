    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recurring_rule', models.CharField(choices=[('NONE', 'Pas de récurrence'), ('DAILY', 'Quotidien'), ('WEEKLY', 'Hebdomadaire'), ('MONTHLY', 'Mensuel'), ('ANNUALLY', 'Annuel')], default='NONE', help_text='Type de recurrence', max_length=10)),
