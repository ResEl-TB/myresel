# -*- coding: utf-8 -*-
# Generated by Django 1.9.12 on 2017-02-18 18:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recurring_rule', models.CharField(choices=[('NONE', 'Pas de récurrence'), ('DAILY', 'Quotidient'), ('WEEKLY', 'Hebdomadaire'), ('MONTHLY', 'Mensuel'), ('ANNUALLY', 'Annuel')], default='NONE', help_text='Type de recurrence', max_length=10)),
                ...
                ('status', models.TextField(choices=[('NEW', 'Non validé'), ('VALIDATED', 'Validé'), ('REFUSED', 'Refusé'), ('DELETED', 'Supprimé')], default='NEW', help_text='Statut', max_length=15)),
                ('organisation', models.TextField(blank=True, max_length=60, null=True)),
